...
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 0.0 | 0.168 | -0.002 | 0.003 | 0.005 | 0.004 | -0.055 | -0.060 | 0.159 | 0.043 | 0.013 | 0.034 | 0.027 | 0.680 |
| 0.1 | 0.169 | -0.002 | 0.003 | 0.006 | 0.005 | -0.055 | -0.059 | 0.157 | 0.027 | 0.015 | 0.035 | 0.031 | 0.677 |
| 0.22 | 0.170 | -0.001 | 0.003 | 0.003 | 0.002 | -0.060 | -0.062 | 0.156 | -0.013 | -0.001 | 0.017 | 0.013 | 0.677 |
| 0.34 | 0.169 | -0.002 | 0.003 | -0.006 | -0.004 | -0.074 | -0.070 | 0.158 | -0.055 | -0.039 | -0.071 | -0.014 | 0.681 |
| 0.46 | 0.168 | -0.002 | 0.002 | -0.010 | -0.006 | -0.082 | -0.076 | 0.159 | -0.086 | -0.055 | -0.201 | -0.019 | 0.684 |
...
Best DTE-EXP3 gain: -0.055 at 0.1.
Best DTE-EXP3 gain over reliability-arbitrated UCB: -0.059 at 0.1.

## label_noise

| Value | DTE Regret | DTE-UCB Gain | Ctx-UCB Gain | Arb-UCB Gain | Rel-Arb Gain | DTE-EXP3 Gain | EXP3-vs-Rel | Gain vs Surprise | DTE - Contextual | DTE - Bandit | DTE - UCB | DTE - EXP3 | DTE Symbolic |
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 0.0 | 0.170 | -0.002 | 0.002 | 0.009 | 0.008 | 0.028 | 0.019 | 0.155 | -0.015 | 0.102 | 0.140 | 0.106 | 0.679 |
| 0.14 | 0.170 | -0.003 | 0.002 | 0.004 | 0.005 | -0.034 | -0.039 | 0.157 | -0.012 | 0.047 | 0.076 | 0.057 | 0.680 |
| 0.28 | 0.170 | -0.001 | 0.003 | 0.003 | 0.002 | -0.060 | -0.062 | 0.156 | -0.013 | -0.001 | 0.017 | 0.013 | 0.677 |
| 0.42 | 0.170 | -0.001 | 0.002 | -0.003 | -0.002 | -0.075 | -0.073 | 0.157 | -0.015 | -0.029 | -0.073 | -0.030 | 0.678 |
| 0.56 | 0.170 | -0.004 | 0.002 | -0.008 | -0.007 | -0.083 | -0.076 | 0.156 | -0.014 | -0.091 | -0.253 | -0.073 | 0.680 |
...
DTE-EXP3 improves DTE at values: [0.0]
DTE-EXP3 improves reliability-arbitrated UCB at values: [0.0]
...
Best DTE-EXP3 gain: 0.028 at 0.0.
Best DTE-EXP3 gain over reliability-arbitrated UCB: 0.019 at 0.0.

## reward_delay

| Value | DTE Regret | DTE-UCB Gain | Ctx-UCB Gain | Arb-UCB Gain | Rel-Arb Gain | DTE-EXP3 Gain | EXP3-vs-Rel | Gain vs Surprise | DTE - Contextual | DTE - Bandit | DTE - UCB | DTE - EXP3 | DTE Symbolic |
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 0 | 0.167 | -0.002 | 0.004 | 0.004 | 0.004 | -0.027 | -0.030 | 0.159 | -0.016 | 0.038 | 0.118 | 0.020 | 0.686 |
| 4 | 0.168 | -0.002 | 0.003 | 0.004 | 0.003 | -0.042 | -0.045 | 0.159 | -0.016 | 0.010 | 0.016 | 0.017 | 0.685 |
| 8 | 0.170 | -0.001 | 0.003 | 0.003 | 0.002 | -0.060 | -0.062 | 0.156 | -0.013 | -0.001 | 0.017 | 0.013 | 0.677 |
| 12 | 0.180 | -0.002 | 0.002 | 0.002 | 0.001 | -0.069 | -0.070 | 0.147 | -0.004 | -0.001 | 0.000 | 0.010 | 0.652 |
| 16 | 0.193 | -0.003 | -0.000 | 0.002 | 0.001 | -0.069 | -0.070 | 0.135 | 0.010 | 0.012 | -0.151 | 0.023 | 0.618 |
...
Best DTE-EXP3 gain: -0.027 at 0.
Best DTE-EXP3 gain over reliability-arbitrated UCB: -0.030 at 0.

## language_degradation

| Value | DTE Regret | DTE-UCB Gain | Ctx-UCB Gain | Arb-UCB Gain | Rel-Arb Gain | DTE-EXP3 Gain | EXP3-vs-Rel | Gain vs Surprise | DTE - Contextual | DTE - Bandit | DTE - UCB | DTE - EXP3 | DTE Symbolic |
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 0.3 | 0.172 | -0.002 | 0.002 | 0.002 | 0.001 | -0.066 | -0.068 | 0.169 | -0.021 | -0.011 | 0.012 | 0.002 | 0.681 |
| 0.45 | 0.171 | -0.002 | 0.003 | 0.002 | 0.001 | -0.064 | -0.066 | 0.166 | -0.018 | -0.008 | 0.014 | 0.007 | 0.680 |
| 0.62 | 0.170 | -0.001 | 0.003 | 0.003 | 0.002 | -0.060 | -0.062 | 0.156 | -0.013 | -0.001 | 0.017 | 0.013 | 0.677 |
| 0.82 | 0.174 | -0.002 | 0.003 | 0.004 | 0.002 | -0.055 | -0.057 | 0.145 | -0.008 | 0.009 | 0.024 | 0.023 | 0.674 |
| 1.0 | 0.177 | -0.001 | 0.003 | 0.004 | 0.003 | -0.050 | -0.053 | 0.136 | -0.004 | 0.016 | 0.031 | 0.025 | 0.670 |
...
Best DTE-EXP3 gain: -0.050 at 1.0.
Best DTE-EXP3 gain over reliability-arbitrated UCB: -0.053 at 1.0.

## verifier_bonus

| Value | DTE Regret | DTE-UCB Gain | Ctx-UCB Gain | Arb-UCB Gain | Rel-Arb Gain | DTE-EXP3 Gain | EXP3-vs-Rel | Gain vs Surprise | DTE - Contextual | DTE - Bandit | DTE - UCB | DTE - EXP3 | DTE Symbolic |
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 0.0 | 0.143 | -0.002 | 0.003 | -0.002 | -0.003 | -0.063 | -0.061 | 0.115 | 0.000 | -0.008 | 0.008 | 0.009 | 0.661 |
| 0.06 | 0.156 | -0.002 | 0.003 | -0.001 | -0.001 | -0.063 | -0.062 | 0.136 | -0.007 | -0.004 | 0.013 | 0.008 | 0.671 |
| 0.12 | 0.170 | -0.001 | 0.003 | 0.003 | 0.002 | -0.060 | -0.062 | 0.156 | -0.013 | -0.001 | 0.017 | 0.013 | 0.677 |
| 0.18 | 0.184 | -0.001 | 0.004 | 0.006 | 0.005 | -0.056 | -0.061 | 0.177 | -0.020 | 0.005 | 0.017 | 0.019 | 0.682 |
| 0.24 | 0.198 | -0.001 | 0.004 | 0.010 | 0.008 | -0.051 | -0.060 | 0.197 | -0.026 | 0.010 | 0.015 | 0.024 | 0.686 |
...
Best DTE-EXP3 gain: -0.051 at 0.24.
Best DTE-EXP3 gain over reliability-arbitrated UCB: -0.060 at 0.24.
